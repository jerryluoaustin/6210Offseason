...
public class Bitmap {
    ...
    public Bitmap(AutoMaster auto){
        ...
        paramWC.vuforiaLicenseKey = "";
        //paramWC.cameraName = LogitechC310;
        vuforia = ClassFactory.getInstance().createVuforia(paramWC);
